...
export class AirExportComponent implements OnInit {
  ...
  getDataTableRows():Promise<any[]>{
    return new Promise((resolve, reject) => {
      ...
      this.httpclient.get(`${this.apiConfig.apiBaseUrl}/api/Cargo/AirExport`).subscribe((response: any) => {
    ...
    // getLocationAirType() {
    //   this.httpclient.get(`http://localhost:5094/api/LocationMaster/getAirList`).subscribe((response: any) => {
